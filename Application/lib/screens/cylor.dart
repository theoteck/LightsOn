...
class CylorPage extends StatefulWidget {
  _CylorPageState createState() => _CylorPageState();
}

class _CylorPageState extends State<CylorPage> {
  ...
  double getValue(int index) {
    return cylonSpeedDelay;
  }

  String getNumber(int index) {
    return cylonSpeedDelay.round().toString();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        floatingActionButton: FloatingActionButton.extended(
          onPressed: () {
            sendData(5, 11, cylonSpeedDelay.toInt());
          },
          label: Text("Apply"),
