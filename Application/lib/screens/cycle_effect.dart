...
class CEffectPage extends StatefulWidget {
  _CEffectPageState createState() => _CEffectPageState();
}

class _CEffectPageState extends State<CEffectPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        floatingActionButton: FloatingActionButton.extended(
          onPressed: () {
            sendData(18, 1, roundColor.toRGBInt());

            sendData(18, 12, roundEffectTime.toInt());
          },
          label: Text("Apply"),
