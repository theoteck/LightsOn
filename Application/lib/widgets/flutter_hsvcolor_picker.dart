// This is a (heavily?) modified version of the flutter_hsvcolor_picker,
// found in https://github.com/fluttercandies/flutter_hsvcolor_picker
// The modifications are in the design of the colorpicker itself
// and so I couldn't just use the package

// The license of the package is unknown, making it closed source,
// but it is available on the pub.dev as https://pub.dev/packages/flutter_hsvcolor_picker
// and on the github page the author encourages downloading the file
  ...
  Widget buildLeftRightColors() {
    return new Container(
        decoration: new BoxDecoration(
            border: new Border.all(color: Colors.grey[850], width: 1),
...
class ColorPickerState extends State<ColorPicker> {
  ...
  DropdownMenuItem<_IPicker> _buildDropdownMenuItems(_IPicker item) {
    return new DropdownMenuItem<_IPicker>(
        value: item,
        child: new Padding(
            padding: const EdgeInsets.fromLTRB(5, 8.0, 0, 0.0),
            child: new Text(
              item.name,
